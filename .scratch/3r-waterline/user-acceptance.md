...
4. 在“设置”中切换“圆形水瓶”和“Traffic Monitor”，并选择大/中/小界面尺寸。关闭设置后，确认设置标题栏可拖动；普通订阅的 Traffic Monitor 只有周、月两条自适应横条，没有滚动条，中/小档文字不加粗且不重叠。标题栏显示当前订阅名，两侧按钮可切换订阅，也可在设置中开启自动切换。翻到“Grok 直充余额”时，确认金额为当前网页顶栏“可用余额”的 ¥ 数值；横条模式只显示一条可用余额轨，水瓶模式只显示居中金额，二者均不显示分母、百分比或“后重置”。
