...
包含直充余额、Graphite Rail 视觉更新与贴边刻度节奏修复的公开社区预览版。

## 下载

- `3R.Waterline_0.1.2_x64-setup.exe`：Windows 安装版（推荐）。
...
- 周/月额度金额显示、订阅切换和自动轮换。
- `Grok 直充余额` 作为可切换项目显示，使用 `$` 美元单位且不伪造额度进度。
- 圆形水瓶、Traffic Monitor、大/中/小尺寸。
- Graphite Rail 深色视觉，订阅名称深色标签与更清晰的周/月贴边刻度分组。
...
- 贴边把手中的 10 段周/月刻度现在采用组内均匀、组间明显分离的节奏。
